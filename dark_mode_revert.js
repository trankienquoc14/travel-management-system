...
const regex = /<div style=\{\{ display: 'flex', flexDirection: 'column', gap: '12px', fontSize: '14px' \}\}>[\s\S]*?<div style=\{\{ display: 'flex', justifyContent: 'space-between', padding: '12px 16px', background: '#fff', border: '1px solid #e2e8f0', borderRadius: '8px', marginTop: '4px' \}\}>[\s\S]*?<\/div>\s*<\/div>/;
                                                ...
                                                return (
                                                    <div style={{ background: '#222', color: '#f8fafc', borderRadius: '12px', padding: '20px', fontFamily: '"Courier New", Courier, monospace', fontSize: '14px', width: '100%', letterSpacing: '0.5px' }}>
                                                        ...
                                                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                                            <div style={{ textTransform: 'uppercase', fontWeight: 'bold', fontSize: '15px', whiteSpace: 'nowrap', marginRight: '8px' }}>TỔNG THANH TOÁN</div>
...
if (code.match(regex)) {
    ...
    console.log('Successfully reverted to DARK MODE receipt.');
} else {
