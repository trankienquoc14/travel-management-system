...
const regex = /\{!\detailBooking\.isService && \(\s*<>\s*<div style=\{\{ display: 'flex'[\s\S]*?Em bé\)<\/span>\s*<\/div>\s*<\/>\s*\)\}/;
...
const replacement = `{!detailBooking.isService && (
                                            (() => {
                                                ...
                                                if (breakdown) {
                                                    ...
                                                    return (
                                                        <div style={{ background: '#1e293b', color: '#f8fafc', borderRadius: '12px', padding: '16px', fontFamily: 'monospace', fontSize: '14px' }}>
                                                            {adults > 0 && (
