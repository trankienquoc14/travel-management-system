...
const regex = /<button[\s\S]*?onClick=\{\(e\) => \{[\s\S]*?\}[\s\S]*?>\s*<i className="fas fa-external-link-alt" style=\{\{ marginRight: '6px' \}\}><\/i> Xem chi tiết lịch trình\s*<\/button>/;
...
console.log('Frontend fetch workaround added');
