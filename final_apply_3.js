...
const regex = /<div style=\{\{ display: 'flex', flexDirection: 'column', gap: '12px', fontSize: '14px' \}\}>[\s\S]*?TỔNG TIỀN THANH TOÁN:<\/span>[\s\S]*?\{formatCurrency\(detailBooking\.total_amount\)\}<\/strong>\s*<\/div>\s*<\/div>/;
                                                ...
                                                return (
                                                    <div style={{ background: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: '12px', padding: '20px', fontSize: '14px', width: '100%' }}>
                                                        ...
                                                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'nowrap', gap: '10px' }}>
                                                            <div style={{ textTransform: 'uppercase', fontWeight: '800', color: '#0f172a', fontSize: '15px', whiteSpace: 'nowrap' }}>TỔNG THANH TOÁN</div>
