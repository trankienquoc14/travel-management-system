...
// 1. Fix List View
c = c.replace(
    /<div>⏱️ Thời gian: <strong>\{tour\.duration_days\} Ngày<\/strong><\/div>/g,
...
// 2. Fix Modal View
const oldModalTop = `<div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginBottom: '24px', background: '#f8fafc', padding: '16px', borderRadius: '8px' }}>
