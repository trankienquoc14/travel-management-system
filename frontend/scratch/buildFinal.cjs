const fs = require('fs');
let c = fs.readFileSync('scratch/BookingForm_history_1.jsx', 'utf8');
...
c = c.replace(oldDummyData, calcLogic);
...
console.log('Restored all perfectly');
