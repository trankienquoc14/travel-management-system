...
const overviewRegex = /<h2>Tổng quan chuyến đi<\/h2>\s*<p className="tour-desc" style=\{\{ whiteSpace: 'pre-line', lineHeight: '1\.8', color: '#475569' \}\}>\s*\{tour\.description \|\| "Hãy cùng chúng tôi khám phá những trải nghiệm tuyệt vời nhất trong chuyến đi này!"\}\s*<\/p>/;
...
c = c.replace(overviewRegex, newOverview);
