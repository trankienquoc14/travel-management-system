              ...
              {activeTab === 'guide_map' && (
                <div style={{ background: '#fff', padding: '20px', borderRadius: '12px', border: '1px solid #e2e8f0' }}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 200px', gap: '16px' }}>
                    <div style={{ border: '1px solid #cbd5e1', borderRadius: '12px', overflow: 'hidden', height: '400px', position: 'relative', background: '#f8fafc', boxShadow: '0 2px 8px rgba(0,0,0,0.03)' }}>
                      <iframe 
                        title="GoogleLiveMap"
                        width="100%" 
                        height="100%" 
