...
// I will extract the whole "Chi Tiết Bảng Tính Tiền" content block
// from `{detailBooking.isService ? (` down to the end of the `Phương thức thanh toán` outer block.

const startStr = `{detailBooking.isService ? (`;
const endStr = `</div>
                                    </div>
                                </div>`;

const startIdx = code.indexOf(startStr);
const outerPaymentIdx = code.indexOf("{/* Removed duplicate outer billing details */}", startIdx);
const endIdx = code.indexOf(endStr, outerPaymentIdx);
...
if (startIdx > 0 && endIdx > 0) {
                                                ...
                                                return (
                                                    <div style={{ background: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: '12px', padding: '20px', fontSize: '14px', width: '100%' }}>
                                                        ...
                                                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'nowrap', gap: '10px' }}>
                                                            ...
                                                            <div style={{ fontSize: '18px', fontWeight: '800', color: '#10b981', whiteSpace: 'nowrap' }}>{formatCurrency(detailBooking.total_amount)}</div>
                                                        </div>
                                                    </div>
                                                );
                                            }
                                                ...
                                                return (
                                                    <div style={{ background: '#f8fafc', border: '1px solid #e2e8f0', color: '#334155', borderRadius: '12px', padding: '20px', fontSize: '14px', width: '100%' }}>
                                                        ...
                                                        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '16px', fontWeight: '600', color: '#475569' }}>
                                                            ...
                                                            <span style={{ color: '#0f172a' }}>{pmText}</span>
                                                        </div>
    ...
    console.log('Successfully refactored unified billing box');
} else {
