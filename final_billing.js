...
const targetRegex = /<div style=\{\{ display: 'flex', flexDirection: 'column', gap: '12px', fontSize: '14px' \}\}>[\s\S]*?<strong style=\{\{ fontSize: '20px', color: '#10b981' \}\}>\{formatCurrency\(detailBooking\.total_amount\)\}<\/strong>\s*<\/div>\s*<\/div>/;
